...
config_dict = {
    ...
    "every_nth_entry": 30,#28 works well for BERT with max 50 seq. 40 # up to 40 seems to work for BERT
    "use_padding": True,
    ...
    "gamma_multistep": 0.5,
    "min_lr_anneal": 1e-6,
    "redo_samples": False, #if loop requires chages to dataset
    "loop_var_name": "num_attention_heads",
    "loop_vals" : [2,4,6,8,10,12,14],
}
